...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    public static class TagHelperServicesExtensions
    {
        ...
        public static IMvcCoreBuilder AddCacheTagHelper(this IMvcCoreBuilder builder)
        {
            ...
            builder.ConfigureCacheTagHelperLimits(options => options.MaximumSize = DefaultCacheMaximumSizeInBytes);
        ...
        public static IMvcBuilder ConfigureCacheTagHelperLimits(this IMvcBuilder builder, Action<CacheTagHelperOptions> configure)
        {
            if (builder == null)
            {
                throw new ArgumentNullException(nameof(builder));
        ...
        /// <param name="configure">The <see cref="Action{CacheTagHelperOptions}"/>to configure the cache options.</param>
        /// <returns>The <see cref="IMvcCoreBuilder"/>.</returns>
        public static IMvcCoreBuilder ConfigureCacheTagHelperLimits(this IMvcCoreBuilder builder, Action<CacheTagHelperOptions> configure)
        {
            if (builder == null)
            {
                throw new ArgumentNullException(nameof(builder));
